			...
			<div class="list-group-item">
				<div class="row">
					<div class="col-sm-12 col-lg-4">
						<p class="mb-0 b text-website">No. Pemesanan: 001536 </p>
						<p>17 Juni 2022</p>
						<p class="mt-4 b text-website">Produk</p>
						<div class="media">
							<img src="https://i.pinimg.com/236x/e5/8e/d4/e58ed4eeb996fb26b15362fa4a241a1c.jpg" class="mr-2" width="60">
					...
					<div class="col-sm-12 col-lg-3">
						...
						<p class="h4">Rp190.000</p>
						<p class="mt-4 b text-website">Customer</p>
						<p class="b">Diki Prasetya</p>
					...
					<div class="col-sm-12 col-lg-3">
						...
						<p class="badge badge-primary">Dikemas dan dikirim</p><br/>
						
						</a>
					</div>
					<div class="col-sm-12 col-lg-2">
						<a href="pemesanan-detail.html">
							<button class="btn bg-website btn-sm mt-5 text-white"><a href="http://localhost/web/home.php">Kembali</button>
						</a>
					</div>
				</div>
			</div>
