	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-website">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<a class="navbar-brand active" href="./">Ayo Bawa Pulang Jersey Pilihanmu</a>
		...
		<div class="card card-body shadow-sm mb-4">
			<div class="row">
				<div class="col-sm-12 col-lg-4">
					<h6 class="text-website">No. Pesanan : 001536</h6>
					<h5>Alamat Pengiriman</h5>
					<p>CS-100231<br>
					Diki Prasetya - 082308121123</p>
				</div>
				<div class="col-sm-12 col-lg-4">
					<h6>17 Juni 2022</h6>
					<p>Jalan Thamrin No.100, Kota Jakarta, Jawa Barat. Indonesia</p>
				</div>
			</div>
		</div>
		<div class="list-group shadow-sm">
			...
			<div class="list-group-item">
				<div class="row my-4">
					<div class="col-sm-12 col-lg-4 mb-3">
						<a href="produk-detail.html" class="hvnb">
							<div class="media">
								<img src="https://i.pinimg.com/736x/04/6f/e4/046fe49d01ceb7df75c985bd0607e2c0.jpg" width="60" class="mr-3">
					...
					<div class="col-sm-12 col-lg-3 mb-3">
						<h4 class="text-website">Rp155.000</h4>
					</div>
					<div class="col-sm-12 col-lg-2 mb-3">
						<h5 class="text-website">1pcs</h5>
					</div>
					<div class="col-sm-12 col-lg-2 mb-3">
						<h5 class="text-website">Rp155.000</h5>
					</div>
				</div>
				...
				<div class="row my-4">
					...
					<div class="col-sm-12 col-lg-3 mb-3">
						Kurir <select class="form-control"><option>JNE REG (3 hari)</option></select>
					</div>
					<div class="col-sm-12 col-lg-2 mb-3">
					</div>
					<div class="col-sm-12 col-lg-2 mb-3">
			...
			<div class="list-group-item">
				<a href="pembayaran.html">
					<button class="btn bg-website text-white float-right"><a href="http://localhost/web/onlineshop/psgpembayaran.php">Lanjut Pembayaran</button>
				</a>
				<div class="float-right h5 mr-3 b text-website">Rp190.000</div>
			</div>
		</div>
	</div>
        ...
        <div class="container pt-4">
            <div class="row text-white">
                ...
                <div class="col-sm-12 col-lg-3">
                    <h5>Tentang Kami</h5>
                    <ul class="list-unstyled">
                        <li><a href="#"><i class="fa fa-map-marker-alt"></i> Jalan Laks. Martdanita 2a, Malang, Indonesia.</a></li>
                        <li><a href="#"><i class="fa fa-envelope"></i> mafifuddin1765@gmail.com</a></li>
                    </ul>
                </div>
                <div class="col-sm-12 col-lg-3">
                    <h5>Media Sosial</h5>
